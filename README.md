...
The table above counts the catalog as it stood on 2026-07-31. Another 121 entries
...
Known consumers: [VitaForge](https://github.com/josephinoo/vitaForge) by josephinoo, and [VHDB](https://github.com/DrDecki/VHDB) by myself.
...
archive.org, which closed over a hundred gaps, and for tracking down sources by hand; to
**LiEnby** for keeping an old cbpsdb mirror alive; to **devnoname120** for finding PSVitaStuff;
