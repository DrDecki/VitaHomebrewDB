...
NAMEN = ["ShowInfo Lite","Please, Don't Touch Anything","OpenXcom","vitaQuakeII","devilutionX",
         ...
         "CTR: High Octane","BattleShip","dRally Vita","VitaMediaDeck","Prince of Persia Classic","Amnesia: The Dark Descent","Barony Vita","Feather Park Vita","Skyrift","RuneScape"]
